            ...
            <main className="container mx-auto px-4 py-20 md:py-28">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-lg dark:prose-invert mt-12 max-w-none">
                        <p>Welcome to our platform. These Terms of Service ("Terms") govern your use of our website, services, and applications (collectively, the "Service"). By accessing or using our Service, you agree to be bound by these Terms.</p>
                        
                        <h2>1. Use of Service</h2>
                        <p>Our platform provides an AI-powered document drafting and analysis tool. You agree to use the Service in compliance with all applicable laws and regulations and not for any unlawful purpose. You must be a licensed legal professional or under the supervision of one to use this service for professional purposes.</p>
                        ...
                        <p>The Service and its original content, features, and functionality are and will remain the exclusive property of our company and its licensors. Our trademarks may not be used in connection with any product or service without our prior written consent.</p>
                        ...
                        <p>The Service is provided on an "AS IS" and "AS AVAILABLE" basis. We do not warrant that the service will be uninterrupted, secure, or error-free. In no event shall our company, nor its directors, employees, or partners, be liable for any indirect, incidental, special, consequential, or punitive damages arising out of your use of the Service.</p>
